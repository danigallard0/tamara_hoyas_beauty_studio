...
<head>
    ...
    <title>Micropigmentación de areolas</title>
...
<body class="bg-pink-50 text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="mb-10">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Micropigmentación de areolas</h1>
            <p class="text-gray-600 max-w-3xl">
                Tratamiento de micropigmentación especializado con finalidad estética y reconstructiva, realizado de forma personalizada.
            </p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <img src="{{ asset('images/servicios/1707381637734-400x284.jpg') }}" alt="Areolas 1"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">

            <img src="{{ asset('images/servicios/micropigmentacion-areola-zaragoza-21.png') }}" alt="Areolas 2"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">

            <img src="{{ asset('images/servicios/05-Micropigmentacion-de-areolas-y-pezones.jpg') }}" alt="Areolas 3"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">
        </div>
    </main>
