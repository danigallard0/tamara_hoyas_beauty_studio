...
<head>
    ...
    <title>Micropigmentación de labios</title>
...
<body class="bg-pink-50 text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="mb-10">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Micropigmentación de labios</h1>
            <p class="text-gray-600 max-w-3xl">
                Técnica orientada a definir el contorno, aportar color y mejorar visualmente la simetría y el aspecto natural de los labios.
            </p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <img src="{{ asset('images/servicios/labios_interior.png') }}" alt="Labios 1"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">

            <img src="{{ asset('images/servicios/Micropigmentacion-de-labios-1.png') }}" alt="Labios 2"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">

            <img src="{{ asset('images/servicios/micropigmentacion-zaragoza.jpg') }}" alt="Labios 3"
                 class="lightbox-image w-full h-80 object-cover rounded-2xl shadow-md cursor-pointer hover:scale-[1.02] transition">
        </div>
    </main>
